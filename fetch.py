...
postcodes_filename = re.findall(
    r'http://www.posti.fi/webpcode/unzip/PCF_[0-9]*?\.dat', index)[0]

# Retrieving the file
postcode_records = urlopen(
    postcodes_filename).read().decode('latin-1').split('\n')
print("Fetched!")
